...
/**
 * Finální služba pro odesílání e-mailů (notifikace, reset hesla).
 * 
 * Místo SMTP používá HTTPS API služby Resend.
 * To zajišťuje spolehlivé doručení i na hostinzích,
 * které blokují klasické SMTP porty (např. Render).
 */
@Service
