...
public class EmailService {
    ...
    private void sendEmail(String to, String subject, String body) {
        try {
            ...
            // Odeslání a vyhodnocení odpovědi
    ...
    /**
     * Pomocná metoda pro escapování speciálních znaků v JSON řetězci.
     *
     * Nutné kvůli tomu, že JSON se sestavuje ručně a uživatelský vstup může
     * obsahovat:
     * - uvozovky,
     * - lomítka,
     * - nové řádky.
