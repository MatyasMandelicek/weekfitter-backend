...
public class JwtService {
    ...
    public String generateToken(String email) {
        ...
        return Jwts.builder()
                .setSubject(email)          // do "subject" ukládáme e-mail
                .setIssuedAt(now)           // čas vytvoření tokenu
                .setExpiration(expiry)      // čas expirace tokenu
                .signWith(getSigningKey(), SignatureAlgorithm.HS256) // podpis
                .compact();
    }
    ...
    private Claims extractAllClaims(String token) {
        return Jwts
                .parserBuilder()
                .setSigningKey(getSigningKey())  // tajný klíč pro ověření podpisu
                .build()
