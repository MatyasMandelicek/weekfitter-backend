 ...
 *
 * Postup:
 * 1. Spring Security ověří e-mail a heslo (AuthenticationManager)
 * 2. Pokud jsou přihlašovací údaje správné:
 *    - načteme uživatele z DB
 *    - vygenerujeme JWT token
 *    - vrátíme ho do FE
 *
 * @throws RuntimeException pokud jsou údaje neplatné
 */
public LoginResponse loginAndCreateToken(String email, String rawPassword) {
    try {
        // Spring Security ověřuje e-mail a heslo
