...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private final JwtService jwtService;                      // stará se o generování/ověření tokenů
    private final CustomUserDetailsService userDetailsService; // stará se o načítání uživatele z DB
            ...
            if (jwtService.isTokenValid(jwt)) {
                ...
                UsernamePasswordAuthenticationToken authToken =
                        new UsernamePasswordAuthenticationToken(
                                userDetails,           // "principal" – přihlášený uživatel
                                null,                  // credentials – nepotřebujeme
                                userDetails.getAuthorities() // seznam práv
                        );
