...
public interface NotificationRepository extends JpaRepository<Notification, UUID> {
    ...
    /**
     * Hromadně smaže všechny notifikace související s danou událostí.
     *
     * @Modifying  → značí, že dotaz mění databázi (není SELECT)
     * @Transactional → vyžaduje transakční kontext
     *
