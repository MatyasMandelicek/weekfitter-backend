...
public class Notification {
    ...
    /**
     * Určuje, zda už byla notifikace odeslána (true),
     * nebo čeká na zpracování (false).
     *
     * Slouží k tomu, aby se e-maily/systémové notifikace neodesílaly vícekrát.
     */
    private boolean sent;

    /**
     * Typ notifikace – definuje, kolik minut/hodin/dní před začátkem události
     * má být uživatel upozorněn.
     *
     * Enum se ukládá jako text (STRING), což je vhodné pro čitelnost i zpětnou kompatibilitu.
     */
