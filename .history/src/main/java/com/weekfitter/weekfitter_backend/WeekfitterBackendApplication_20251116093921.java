...
public class WeekfitterBackendApplication {
    ...
    public static void main(String[] args) {
        ...
        /**
     * Provede jednoduchý JPQL dotaz po startu aplikace.
     *
     * Cíl:
     * - inicializovat Hibernate,
     * - navázat spojení s databází,
     * - urychlit první HTTP požadavek z frontendu.
     *
     * Pokud připojení k databázi selže, vypíše se pouze varování,
     * aplikace ale spustí dál (Hibernate se znovu pokusí připojit při prvním requestu).
     */
