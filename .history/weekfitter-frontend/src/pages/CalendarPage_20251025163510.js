...
const CalendarPage = () => {
  ...
  // === Vlastní render události s ikonou ===
  ...
  const handleSelectSlot = (slotInfo) => {
    ...
    // Měsíční pohled → default 8:00–8:30
    if (view === "month") {
  ...
  // === Přepočet konce při změně trvání nebo startu ===
  ...
  // === Odeslání formuláře (nezměněno) ===
  const handleSubmit = async (e) => {
    e.preventDefault();
    // ... (zbytek stejné logiky jako teď máš)
  };
      ...
      <main className="calendar-container">
        <div className="calendar-card">
          ...
          <Calendar
            ...
            components={{ event: CustomEvent }}  {/* ← přidáno */}
            view={view}
            date={date}
            onView={setView}
            onNavigate={setDate}
