...
import {  parseISO, startOfWeek, endOfWeek, startOfMonth, endOfMonth, startOfYear, endOfYear, isWithinInterval, format, eachDayOfInterval, eachWeekOfInterval, addDays,
} from "date-fns";
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        // zkusíme přetypovat na JSON (pokud to JSON není, vytvoříme prázdné pole)
        let data;
        try {
