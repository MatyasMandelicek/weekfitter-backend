...
const CalendarPage = () => {
  ...
  const handleSelectSlot = (slotInfo) => {
    ...
    const localDate = new Date(clickedDate.toLocaleDateString - clickedDate.getTimezoneOffset() * 60000);

    const defaultStart = setHours(setMinutes(localDate, 0), 8);
    const defaultEnd = setHours(setMinutes(localDate, 30), 8);
