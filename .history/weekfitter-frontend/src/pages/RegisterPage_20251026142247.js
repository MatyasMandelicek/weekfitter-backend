...
const RegisterPage = () => {
  ...
  // kliknutí na avatar – nastaví pohlaví i výchozí profilový obrázek
  const handleGenderSelect = (gender) => {
    let avatar = "";
    if (gender === "MALE") avatar = MaleAvatar;
    else if (gender === "FEMALE") avatar = FemaleAvatar;
      ...
      <main className="register-container">
        <div className="register-card">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" clas disabled={loading}>
